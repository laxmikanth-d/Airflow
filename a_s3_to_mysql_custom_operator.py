...
from airflow.providers.adhoc.operators.json_to_csv_operator import JsonToCSVOperator
...
with DAG('s3toMysqlCustomOperator', default_args=default_args, tags=['lax'], schedule_interval="@once") as dag:
    ...
    t3 = JsonToCSVOperator(
        task_id='create_csv',
        input_path=JSON_LOCAL_PATH,
        output_path=CSV_LOCAL_PATH
    )
